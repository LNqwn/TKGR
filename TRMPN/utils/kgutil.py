...
class RGCNLinkDataset(object):
    ...
    train: numpy.array
        all relation triplets (model, rel, dst) for training
    valid: numpy.array
        all relation triplets (model, rel, dst) for validation
    test: numpy.array
        all relation triplets (model, rel, dst) for testing
...
def _read_dictionary(filename):
    d = {}
    print("fileName--",filename)#../../data\ICEWS18\entity2id.txt
